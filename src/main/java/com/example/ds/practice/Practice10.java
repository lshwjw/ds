...
public class Practice10 {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(practice.isMatch("mississippi", "mis*is*p*."));//false
        System.out.println(practice.isMatch("mississippi", "mis*is*p*."));//false
        System.out.println(practice.isMatch("ab", ".*"));//true
        System.out.println(practice.isMatch("mississippi", "mis*is*ip*."));//true
        System.out.println(practice.isMatch("ab", ".*c"));//false
    }
}
